let config = [
    {
        ...
        list_attributes:['capability_type','capability_name','adopting_authority', 'responsible_authority','adoption_authority'], // to list the attributes on the main page
        sub_type:'',
        filter_list_attributes:{filter:'capability_category',value:'planning and regulatory'},
        // if wizard
        sections: [],
        attributes: {
            county:{
