...
class Charts extends Component {
	...
	/*	let min = Infinity;
		...
		let treeRingColor = colors['ylOrRdBig'] 
		    ...
		    /*.range(["#a50026", "#ffffbf", "#006837"]);  */ // red yellow green
			/*.range(["#800026", "#fd8d3c", "#ffffcc"]); */     //red  to yellow
			/*.range(["#8e0152", "#f7f7f7", "#276419"]); */      //purple white green
			/*.range(["#8e0152", "#f7f7f7", "#276419"]);*/    //pinkish white green 

		let lineColor = "#18a4f9"
		 // greenish --c7e9c0, 7fc97f, 4d9221 , yellow- ffffbf, white - fefefe blue-18a4f9 orange-fd6642
